//
//  UITDrawViewController.swift
//  UIT-CE
//
//  Created by Lee Hoa on 9/8/16.
...
class UITDrawViewController: UIViewController
{
    static let identifier = String(UITDrawViewController)
...
// MARK: - CanvasDelegate
extension UITDrawViewController: CanvasDelegate
{
    func brush() -> Brush? {
...
extension UITDrawViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate
{
...
extension UITDrawViewController: RSKImageCropViewControllerDelegate
{
...
extension UITDrawViewController: UIActionSheetDelegate
{
...
extension UITDrawViewController: UIAlertViewDelegate
{
...
extension UITDrawViewController: PaletteDelegate
{
